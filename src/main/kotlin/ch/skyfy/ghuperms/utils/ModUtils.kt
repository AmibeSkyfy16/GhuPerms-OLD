...
import ch.skyfy.ghuperms.api.utils.Perm
...
fun setupConfigDirectory() {
    try {
        if (!GhuPermsMod.CONFIG_DIRECTORY.exists()) GhuPermsMod.CONFIG_DIRECTORY.createDirectory()
    } catch (e: java.lang.Exception) {
        GhuPermsMod.LOGGER.fatal("An exception occurred. Could not create the root folder that should contain the configuration files")
